...
static void providedExample()
{
	...
	MoveVehicle<gameBoard, 2, 3, LEFT, 2>::board b1;
	(void)b1; // Valid move (cast to void to suppress 'unused' warnings)
...
static void moveVehicle_game_Test()
{
	 ...
	 */
	typedef MoveVehicle<gameBoard, 4, 1, DOWN, 1>::board b01; /* C */
	Printer<b01>::print(std::cout);
	typedef MoveVehicle<b01, 3, 5, UP, 2>::board b02; /* P */
	Printer<b02>::print(std::cout);
	typedef MoveVehicle<b02, 3, 2, RIGHT, 2>::board b03; /* D */
	Printer<b03>::print(std::cout);
	typedef MoveVehicle<b03, 0, 3, DOWN, 3>::board b04; /* R */
	Printer<b04>::print(std::cout);
	typedef MoveVehicle<b04, 2, 1, RIGHT, 1>::board b05; /* X */
	Printer<b05>::print(std::cout);
	typedef MoveVehicle<b05, 5, 1, UP, 4>::board b06; /* C */
	Printer<b06>::print(std::cout);
	typedef MoveVehicle<b06, 2, 2, LEFT, 1>::board b07; /* X */
	Printer<b07>::print(std::cout);
	typedef MoveVehicle<b07, 3, 3, UP, 3>::board b08; /* R */
	Printer<b08>::print(std::cout);
	typedef MoveVehicle<b08, 3, 5, LEFT, 4>::board b09; /* D */
	Printer<b09>::print(std::cout);
	typedef MoveVehicle<b09, 5, 5, LEFT, 4>::board b10; /* F */
	Printer<b10>::print(std::cout);
	typedef MoveVehicle<b10, 1, 5, DOWN, 3>::board b11; /* P */
	Printer<b11>::print(std::cout);
	typedef MoveVehicle<b11, 1, 3, DOWN, 3>::board b12; /* R */
	Printer<b12>::print(std::cout);
...
static void checkSolution_game_Test()
{
	...
	typedef GameBoard<List<
		...
		List<BoardCell<EMPTY, RIGHT, 0>, BoardCell<C, DOWN, 2>, BoardCell<D, LEFT, 2>, BoardCell<D, LEFT, 2>, BoardCell<EMPTY, RIGHT, 0>, BoardCell<P, UP, 3>>,
		List<BoardCell<EMPTY, RIGHT, 0>, BoardCell<C, DOWN, 2>, BoardCell<EMPTY, RIGHT, 0>, BoardCell<EMPTY, RIGHT, 0>, BoardCell<EMPTY, RIGHT, 0>, BoardCell<P, UP, 3>>,
		List<BoardCell<EMPTY, RIGHT, 0>, BoardCell<EMPTY, RIGHT, 0>, BoardCell<EMPTY, UP, 2>, BoardCell<EMPTY, RIGHT, 0>, BoardCell<F, RIGHT, 2>, BoardCell<F, RIGHT, 0>>>>
		gameBoard;
...
static void moveVehicleErrorsTest()
{
	...
	// index out of bounds:
	MoveVehicle<board2x3, -1, 1, LEFT, 1> m1;
	(void)m1;
	MoveVehicle<board2x3, 1, -1, LEFT, 1> m2;
	(void)m2;
	MoveVehicle<board2x3, 3, 1, LEFT, 1> m3;
	(void)m3;
	MoveVehicle<board2x3, 1, 2, LEFT, 1> m4;
	(void)m4;

	// move empty cell:
	MoveVehicle<board2x3, 0, 0, RIGHT, 1> m10;
	(void)m10;

	// move in bad direction (sideways)
	MoveVehicle<board2x3, 1, 0, UP, 1> m21;
	(void)m21;
	MoveVehicle<board2x3, 1, 0, DOWN, 1> m22;
	(void)m22;
	MoveVehicle<board2x3, 1, 1, LEFT, 1> m23;
	(void)m23;
	MoveVehicle<board2x3, 1, 1, RIGHT, 1> m24;
	(void)m24;
	...
	MoveVehicle<board2x3, 2, 3, RIGHT, 1> m30;
	(void)m30; // X
	MoveVehicle<board2x3, 4, 3, LEFT, 1> m31;
	(void)m31; // P
	MoveVehicle<board2x3, 5, 2, UP, 4> m32;
	(void)m32; // B
	MoveVehicle<board2x3, 1, 4, DOWN, 2> m33;
	(void)m33; // O
}
...
static void takeDropListTest()
{
	...
	Take<1, List<Int<1>>>::list m1;
	(void)m1;
	Drop<1, List<Int<1>>>::list m2;
	(void)m2;
	Take<0, List<Int<1>>>::list m3;
	(void)m3;
	Drop<0, List<Int<1>>>::list m4;
	(void)m4;
	Take<0, List<>>::list m5;
	(void)m5;
	Drop<0, List<>>::list m6;
...
static void concatTest()
{
	...
	Concat<List<Int<1>>, List<>>::list m1;
	(void)m1;
	Concat<List<>, List<Int<1>>>::list m2;
	(void)m2;
	Concat<List<>, List<>>::list m3;
	(void)m3;
...
static void providedExampleStepByStep()
{
	...
	Printer<gameBoard>::print(std::cout);
	typedef DoMove<gameBoard, Move<B, UP, 1>>::result b01;
	Printer<b01>::print(std::cout);
	typedef DoMove<b01, Move<C, LEFT, 4>>::result b02;
	Printer<b02>::print(std::cout);
	typedef DoMove<b02, Move<A, LEFT, 2>>::result b03;
	Printer<b03>::print(std::cout);
	typedef DoMove<b03, Move<X, LEFT, 2>>::result b04;
	Printer<b04>::print(std::cout);
	typedef DoMove<b04, Move<B, UP, 3>>::result b05;
	Printer<b05>::print(std::cout);
	typedef DoMove<b05, Move<P, LEFT, 3>>::result b06;
	Printer<b06>::print(std::cout);
	typedef DoMove<b06, Move<O, DOWN, 3>>::result b07;
	Printer<b07>::print(std::cout);
